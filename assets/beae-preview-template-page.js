...
(() => { if (window.BEAEPAGEJS === undefined) {
          ...
          window.beaePageSetting.pageId = "69707b36c7af72799d0a45d3";
              window.beaePageSetting.pageTitle = "Ricco_Internship-Landing Page "; 
              window.beaePageSetting.pageType = "page";

          let js_NPNJCNA9 = () => { let BeaeUseHooks = {};
      try {
        let argid = 'beae-sqsyhwohsection-js',
        ...
        args.els = document.querySelectorAll('.beae-sqsyhwoh');
        args.el = args.els[0];
        ...
        console.error('BEAE JS ERROR ID beae-sqsyhwoh: ', ex)
      };
    

      try {
        let argid = 'beae-sqsyhwohsection-developer',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-sqsyhwoh',
        ...
        args.el = args.els[0];
        ((data
) => { const headerElement = document.querySelector('.beae-section.beae-core.beae-custom-header');
...
if (headerElement) {
    ...
    console.error('Failed');
      ...
      try {
        let argid = 'beae-sqsyhwohlanding-header-js',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-sqsyhwoh',
        ...
        args.els = document.querySelectorAll('.beae-sqsyhwoh');
        args.el = args.els[0];
        ((a) => { if(a.el.querySelectorAll(".beae-landing-header__navigation a").forEach(n=>{let t=n.getAttribute("href");t&&t!=="#"&&document.querySelector(t)&&n.addEventListener("click",o=>{o.preventDefault(),document.querySelector(t).scrollIntoView({behavior:"smooth"})})}),!window.BeaeLandingHeaderInit){window.BeaeLandingHeaderInit=!0;let n=0,t=1;document.addEventListener("scroll",o=>{let r=document.documentElement.scrollTop||document.body.scrollTop,s=1;r===0?s=0:r<window.innerHeight*.5?s=1:s=n>r?1:-1,s!==t&&document.querySelectorAll(".beae-landing-header").forEach(u=>{u.closest(".beae-section")&&u.closest(".beae-section").setAttribute("data-sticky",s.toString())}),t=s,n=r})} })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-sqsyhwoh: ', ex)
      };
      ...
      try {
        let argid = 'beae-g3m8nwaqsection-js',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-g3m8nwaq',
        ...
        args.els = document.querySelectorAll('.beae-g3m8nwaq');
        args.el = args.els[0];
        ((t) => { var o;if((o=t.el.querySelector(".beae-grid-system"))==null||o.addEventListener("scroll",a=>{var r,l;let n=a.target;if(!n.classList.contains("beae-grid-carousel"))return;let s=Math.round((n.scrollLeft+n.querySelector(".beae-grid-carousel__snaps").offsetLeft)/(n.offsetWidth*.8))+1;(r=t.el.querySelector(".beae-grid-carousel__pagination div.active"))==null||r.classList.remove("active"),(l=t.el.querySelector('.beae-grid-carousel__pagination div[data-index="'+s+'"]'))==null||l.classList.add("active")}),t.mode.value=="live"){const a=t.el.querySelector('.beae-section-background-video[data-device="desktop"]'),n=t.el.querySelector('.beae-section-background-video[data-device="mobile"]'),s=[];window.BEAEVIDEO&&window.BEAEVIDEO.convertBackgroundSection&&(window.innerWidth>=768?a&&window.BEAEVIDEO.convertBackgroundSection(t.optionsVideo,a)&&s.push("desktop"):n&&window.BEAEVIDEO.convertBackgroundSection(t.optionsVideoMobile,n)&&s.push("mobile")),(a||n)&&window.addEventListener("resize",()=>{if(window.BEAEVIDEO&&window.BEAEVIDEO.convertBackgroundSection){if(!s.includes("desktop")&&window.innerWidth>=768&&a){const r=window.BEAEVIDEO.convertBackgroundSection(t.optionsVideo,a);r&&(a.innerHTML=r.html,s.push("desktop"))}if(!s.includes("mobile")&&window.innerWidth<768&&n){const r=window.BEAEVIDEO.convertBackgroundSection(t.optionsVideoMobile,n);r&&(n.innerHTML=r.html,s.push("mobile"))}}})}t.el.querySelectorAll(".beae-text-highlight").forEach(a=>{new IntersectionObserver((s,r)=>{s.forEach(l=>{l.isIntersecting&&(l.target.querySelectorAll("path, line").forEach(c=>{c.style.strokeDasharray=parseFloat(c.getAttribute("data-dash-ratio")*l.target.offsetWidth*2)+"px, 999999px"}),r.unobserve(l.target))})},{root:document,rootMargin:"0px 0px -40%"}).observe(a)}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-g3m8nwaq: ', ex)
      };
    

      try {
        let argid = 'beae-k6bzx7pfblock-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-k6bzx7pf',
        ...
        args.els = document.querySelectorAll('.beae-k6bzx7pf');
        args.el = args.els[0];
        ...
        console.error('BEAE JS ERROR ID beae-k6bzx7pf: ', ex)
      };
    

      try {
        let argid = 'beae-1381rsx0block-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-1381rsx0',
        ...
        args.els = document.querySelectorAll('.beae-1381rsx0');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-1381rsx0: ', ex)
      };
    

      try {
        let argid = 'beae-zmfp9jpnbutton-js',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-zmfp9jpn',
        ...
        args.els = document.querySelectorAll('.beae-zmfp9jpn');
        args.el = args.els[0];
        ...
        console.error('BEAE JS ERROR ID beae-zmfp9jpn: ', ex)
      };
    

      try {
        let argid = 'beae-5p01a0uyblock-image',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-5p01a0uy',
        ...
        args.els = document.querySelectorAll('.beae-5p01a0uy');
        args.el = args.els[0];
        ...
        console.error('BEAE JS ERROR ID beae-5p01a0uy: ', ex)
      };
    

      try {
        let argid = 'beae-79lh8gaksection-js',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-79lh8gak',
        ...
        args.els = document.querySelectorAll('.beae-79lh8gak');
        args.el = args.els[0];
        ((t) => { var o;if((o=t.el.querySelector(".beae-grid-system"))==null||o.addEventListener("scroll",a=>{var r,l;let n=a.target;if(!n.classList.contains("beae-grid-carousel"))return;let s=Math.round((n.scrollLeft+n.querySelector(".beae-grid-carousel__snaps").offsetLeft)/(n.offsetWidth*.8))+1;(r=t.el.querySelector(".beae-grid-carousel__pagination div.active"))==null||r.classList.remove("active"),(l=t.el.querySelector('.beae-grid-carousel__pagination div[data-index="'+s+'"]'))==null||l.classList.add("active")}),t.mode.value=="live"){const a=t.el.querySelector('.beae-section-background-video[data-device="desktop"]'),n=t.el.querySelector('.beae-section-background-video[data-device="mobile"]'),s=[];window.BEAEVIDEO&&window.BEAEVIDEO.convertBackgroundSection&&(window.innerWidth>=768?a&&window.BEAEVIDEO.convertBackgroundSection(t.optionsVideo,a)&&s.push("desktop"):n&&window.BEAEVIDEO.convertBackgroundSection(t.optionsVideoMobile,n)&&s.push("mobile")),(a||n)&&window.addEventListener("resize",()=>{if(window.BEAEVIDEO&&window.BEAEVIDEO.convertBackgroundSection){if(!s.includes("desktop")&&window.innerWidth>=768&&a){const r=window.BEAEVIDEO.convertBackgroundSection(t.optionsVideo,a);r&&(a.innerHTML=r.html,s.push("desktop"))}if(!s.includes("mobile")&&window.innerWidth<768&&n){const r=window.BEAEVIDEO.convertBackgroundSection(t.optionsVideoMobile,n);r&&(n.innerHTML=r.html,s.push("mobile"))}}})}t.el.querySelectorAll(".beae-text-highlight").forEach(a=>{new IntersectionObserver((s,r)=>{s.forEach(l=>{l.isIntersecting&&(l.target.querySelectorAll("path, line").forEach(c=>{c.style.strokeDasharray=parseFloat(c.getAttribute("data-dash-ratio")*l.target.offsetWidth*2)+"px, 999999px"}),r.unobserve(l.target))})},{root:document,rootMargin:"0px 0px -40%"}).observe(a)}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-79lh8gak: ', ex)
      };
    

      try {
        let argid = 'beae-2j5qnd9p',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-2j5qnd9p',
        ...
        args.els = document.querySelectorAll('.beae-2j5qnd9p');
        args.el = args.els[0];
        ...
        console.error('BEAE JS ERROR ID beae-2j5qnd9p: ', ex)
      };
    

      try {
        let argid = 'beae-pkkfai8lblock-textloop-0',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-pkkfai8l',
        ...
        args.els = document.querySelectorAll('.beae-pkkfai8l');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-pkkfai8l: ', ex)
      };
    

      try {
        let argid = 'beae-pkkfai8lblock-textloop-1',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-pkkfai8l',
      ...
      try {
        let argid = 'beae-pkkfai8lblock-textloop-2',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-pkkfai8l',
      ...
      try {
        let argid = 'beae-pkkfai8lblock-textloop-3',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-pkkfai8l',
      ...
      try {
        let argid = 'beae-pkkfai8lblock-textloop-4',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-pkkfai8l',
      ...
      try {
        let argid = 'beae-0r38hmqtsection-js',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-0r38hmqt',
        ...
        args.els = document.querySelectorAll('.beae-0r38hmqt');
        args.el = args.els[0];
        ((t) => { var o;if((o=t.el.querySelector(".beae-grid-system"))==null||o.addEventListener("scroll",a=>{var r,l;let n=a.target;if(!n.classList.contains("beae-grid-carousel"))return;let s=Math.round((n.scrollLeft+n.querySelector(".beae-grid-carousel__snaps").offsetLeft)/(n.offsetWidth*.8))+1;(r=t.el.querySelector(".beae-grid-carousel__pagination div.active"))==null||r.classList.remove("active"),(l=t.el.querySelector('.beae-grid-carousel__pagination div[data-index="'+s+'"]'))==null||l.classList.add("active")}),t.mode.value=="live"){const a=t.el.querySelector('.beae-section-background-video[data-device="desktop"]'),n=t.el.querySelector('.beae-section-background-video[data-device="mobile"]'),s=[];window.BEAEVIDEO&&window.BEAEVIDEO.convertBackgroundSection&&(window.innerWidth>=768?a&&window.BEAEVIDEO.convertBackgroundSection(t.optionsVideo,a)&&s.push("desktop"):n&&window.BEAEVIDEO.convertBackgroundSection(t.optionsVideoMobile,n)&&s.push("mobile")),(a||n)&&window.addEventListener("resize",()=>{if(window.BEAEVIDEO&&window.BEAEVIDEO.convertBackgroundSection){if(!s.includes("desktop")&&window.innerWidth>=768&&a){const r=window.BEAEVIDEO.convertBackgroundSection(t.optionsVideo,a);r&&(a.innerHTML=r.html,s.push("desktop"))}if(!s.includes("mobile")&&window.innerWidth<768&&n){const r=window.BEAEVIDEO.convertBackgroundSection(t.optionsVideoMobile,n);r&&(n.innerHTML=r.html,s.push("mobile"))}}})}t.el.querySelectorAll(".beae-text-highlight").forEach(a=>{new IntersectionObserver((s,r)=>{s.forEach(l=>{l.isIntersecting&&(l.target.querySelectorAll("path, line").forEach(c=>{c.style.strokeDasharray=parseFloat(c.getAttribute("data-dash-ratio")*l.target.offsetWidth*2)+"px, 999999px"}),r.unobserve(l.target))})},{root:document,rootMargin:"0px 0px -40%"}).observe(a)}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-0r38hmqt: ', ex)
      };
    

      try {
        let argid = 'beae-1ff2evtiblock-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-1ff2evti',
        ...
        args.els = document.querySelectorAll('.beae-1ff2evti');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-1ff2evti: ', ex)
      };
    

      try {
        let argid = 'beae-0syaq9d1block-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-0syaq9d1',
        ...
        args.els = document.querySelectorAll('.beae-0syaq9d1');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-0syaq9d1: ', ex)
      };
    

      try {
        let argid = 'beae-vv31gxpbsection-slide-show',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-vv31gxpb',
        ...
        args.els = document.querySelectorAll('.beae-vv31gxpb');
        args.el = args.els[0];
        ((h) => { window.BeaeSlider&&!h.noRunJs&&window.BeaeSlider(h) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-vv31gxpb: ', ex)
      };
    

      try {
        let argid = 'beae-7vhtmyyzblock-imageloop-0',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-7vhtmyyz',
        ...
        args.els = document.querySelectorAll('.beae-7vhtmyyz');
        args.el = args.els[0];
        ((M) => { var P;if(M.el){if(M.shape){const O=M.el.closest(".beae-slider-items");O&&!O.hasAttribute("data-svg")&&(O==null||O.closest(".beae-section").insertAdjacentHTML("beforeend",`
                            <svg width="0" height="0" style="height: 0px !important; width: 0px !important; opacity: 0 !important;">
                            <defs>
        ...
        console.error('BEAE JS ERROR ID beae-7vhtmyyz: ', ex)
      };
    

      try {
        let argid = 'beae-e3a0klftblock-textloop-0',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-e3a0klft',
        ...
        args.els = document.querySelectorAll('.beae-e3a0klft');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-e3a0klft: ', ex)
      };
    

      try {
        let argid = 'beae-7vhtmyyzblock-imageloop-1',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-7vhtmyyz',
      ...
      try {
        let argid = 'beae-e3a0klftblock-textloop-1',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-e3a0klft',
      ...
      try {
        let argid = 'beae-a6n7g4bksection-js',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-a6n7g4bk',
        ...
        args.els = document.querySelectorAll('.beae-a6n7g4bk');
        args.el = args.els[0];
        ((t) => { var o;if((o=t.el.querySelector(".beae-grid-system"))==null||o.addEventListener("scroll",a=>{var r,l;let n=a.target;if(!n.classList.contains("beae-grid-carousel"))return;let s=Math.round((n.scrollLeft+n.querySelector(".beae-grid-carousel__snaps").offsetLeft)/(n.offsetWidth*.8))+1;(r=t.el.querySelector(".beae-grid-carousel__pagination div.active"))==null||r.classList.remove("active"),(l=t.el.querySelector('.beae-grid-carousel__pagination div[data-index="'+s+'"]'))==null||l.classList.add("active")}),t.mode.value=="live"){const a=t.el.querySelector('.beae-section-background-video[data-device="desktop"]'),n=t.el.querySelector('.beae-section-background-video[data-device="mobile"]'),s=[];window.BEAEVIDEO&&window.BEAEVIDEO.convertBackgroundSection&&(window.innerWidth>=768?a&&window.BEAEVIDEO.convertBackgroundSection(t.optionsVideo,a)&&s.push("desktop"):n&&window.BEAEVIDEO.convertBackgroundSection(t.optionsVideoMobile,n)&&s.push("mobile")),(a||n)&&window.addEventListener("resize",()=>{if(window.BEAEVIDEO&&window.BEAEVIDEO.convertBackgroundSection){if(!s.includes("desktop")&&window.innerWidth>=768&&a){const r=window.BEAEVIDEO.convertBackgroundSection(t.optionsVideo,a);r&&(a.innerHTML=r.html,s.push("desktop"))}if(!s.includes("mobile")&&window.innerWidth<768&&n){const r=window.BEAEVIDEO.convertBackgroundSection(t.optionsVideoMobile,n);r&&(n.innerHTML=r.html,s.push("mobile"))}}})}t.el.querySelectorAll(".beae-text-highlight").forEach(a=>{new IntersectionObserver((s,r)=>{s.forEach(l=>{l.isIntersecting&&(l.target.querySelectorAll("path, line").forEach(c=>{c.style.strokeDasharray=parseFloat(c.getAttribute("data-dash-ratio")*l.target.offsetWidth*2)+"px, 999999px"}),r.unobserve(l.target))})},{root:document,rootMargin:"0px 0px -40%"}).observe(a)}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-a6n7g4bk: ', ex)
      };
    

      try {
        let argid = 'beae-ura4tyy0block-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-ura4tyy0',
        ...
        args.els = document.querySelectorAll('.beae-ura4tyy0');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-ura4tyy0: ', ex)
      };
    

      try {
        let argid = 'beae-rkn41gvoblock-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-rkn41gvo',
        ...
        args.els = document.querySelectorAll('.beae-rkn41gvo');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-rkn41gvo: ', ex)
      };
    

      try {
        let argid = 'beae-67fk9ftasection-slide-show',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-67fk9fta',
        ...
        args.els = document.querySelectorAll('.beae-67fk9fta');
        args.el = args.els[0];
        ((h) => { window.BeaeSlider&&!h.noRunJs&&window.BeaeSlider(h) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-67fk9fta: ', ex)
      };
    

      try {
        let argid = 'beae-kw6qj9q1block-imageloop-0',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-kw6qj9q1',
        ...
        args.els = document.querySelectorAll('.beae-kw6qj9q1');
        args.el = args.els[0];
        ((M) => { var P;if(M.el){if(M.shape){const O=M.el.closest(".beae-slider-items");O&&!O.hasAttribute("data-svg")&&(O==null||O.closest(".beae-section").insertAdjacentHTML("beforeend",`
                            <svg width="0" height="0" style="height: 0px !important; width: 0px !important; opacity: 0 !important;">
                            <defs>
        ...
        console.error('BEAE JS ERROR ID beae-kw6qj9q1: ', ex)
      };
    

      try {
        let argid = 'beae-p68gpzbjblock-textloop-0',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-p68gpzbj',
        ...
        args.els = document.querySelectorAll('.beae-p68gpzbj');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-p68gpzbj: ', ex)
      };
    

      try {
        let argid = 'beae-kw6qj9q1block-imageloop-1',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-kw6qj9q1',
      ...
      try {
        let argid = 'beae-p68gpzbjblock-textloop-1',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-p68gpzbj',
      ...
      try {
        let argid = 'beae-kw6qj9q1block-imageloop-2',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-kw6qj9q1',
      ...
      try {
        let argid = 'beae-p68gpzbjblock-textloop-2',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-p68gpzbj',
      ...
      try {
        let argid = 'beae-kw6qj9q1block-imageloop-3',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-kw6qj9q1',
      ...
      try {
        let argid = 'beae-p68gpzbjblock-textloop-3',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-p68gpzbj',
      ...
      try {
        let argid = 'beae-kw6qj9q1block-imageloop-4',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-kw6qj9q1',
      ...
      try {
        let argid = 'beae-p68gpzbjblock-textloop-4',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-p68gpzbj',
      ...
      try {
        let argid = 'beae-kw6qj9q1block-imageloop-5',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-kw6qj9q1',
      ...
      try {
        let argid = 'beae-p68gpzbjblock-textloop-5',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-p68gpzbj',
      ...
      try {
        let argid = 'beae-tz2r8nh7section-js',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-tz2r8nh7',
        ...
        args.els = document.querySelectorAll('.beae-tz2r8nh7');
        args.el = args.els[0];
        ((t) => { var o;if((o=t.el.querySelector(".beae-grid-system"))==null||o.addEventListener("scroll",a=>{var r,l;let n=a.target;if(!n.classList.contains("beae-grid-carousel"))return;let s=Math.round((n.scrollLeft+n.querySelector(".beae-grid-carousel__snaps").offsetLeft)/(n.offsetWidth*.8))+1;(r=t.el.querySelector(".beae-grid-carousel__pagination div.active"))==null||r.classList.remove("active"),(l=t.el.querySelector('.beae-grid-carousel__pagination div[data-index="'+s+'"]'))==null||l.classList.add("active")}),t.mode.value=="live"){const a=t.el.querySelector('.beae-section-background-video[data-device="desktop"]'),n=t.el.querySelector('.beae-section-background-video[data-device="mobile"]'),s=[];window.BEAEVIDEO&&window.BEAEVIDEO.convertBackgroundSection&&(window.innerWidth>=768?a&&window.BEAEVIDEO.convertBackgroundSection(t.optionsVideo,a)&&s.push("desktop"):n&&window.BEAEVIDEO.convertBackgroundSection(t.optionsVideoMobile,n)&&s.push("mobile")),(a||n)&&window.addEventListener("resize",()=>{if(window.BEAEVIDEO&&window.BEAEVIDEO.convertBackgroundSection){if(!s.includes("desktop")&&window.innerWidth>=768&&a){const r=window.BEAEVIDEO.convertBackgroundSection(t.optionsVideo,a);r&&(a.innerHTML=r.html,s.push("desktop"))}if(!s.includes("mobile")&&window.innerWidth<768&&n){const r=window.BEAEVIDEO.convertBackgroundSection(t.optionsVideoMobile,n);r&&(n.innerHTML=r.html,s.push("mobile"))}}})}t.el.querySelectorAll(".beae-text-highlight").forEach(a=>{new IntersectionObserver((s,r)=>{s.forEach(l=>{l.isIntersecting&&(l.target.querySelectorAll("path, line").forEach(c=>{c.style.strokeDasharray=parseFloat(c.getAttribute("data-dash-ratio")*l.target.offsetWidth*2)+"px, 999999px"}),r.unobserve(l.target))})},{root:document,rootMargin:"0px 0px -40%"}).observe(a)}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-tz2r8nh7: ', ex)
      };
    

      try {
        let argid = 'beae-8k64m60gblock-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-8k64m60g',
        ...
        args.els = document.querySelectorAll('.beae-8k64m60g');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-8k64m60g: ', ex)
      };
    

      try {
        let argid = 'beae-x032uztzblock-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-x032uztz',
        ...
        args.els = document.querySelectorAll('.beae-x032uztz');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-x032uztz: ', ex)
      };
    

      try {
        let argid = 'beae-do4yn546section-slide-show',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-do4yn546',
        ...
        args.els = document.querySelectorAll('.beae-do4yn546');
        args.el = args.els[0];
        ((h) => { window.BeaeSlider&&!h.noRunJs&&window.BeaeSlider(h) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-do4yn546: ', ex)
      };
    

      try {
        let argid = 'beae-fncz5lzublock-imageloop-0',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-fncz5lzu',
        ...
        args.els = document.querySelectorAll('.beae-fncz5lzu');
        args.el = args.els[0];
        ((M) => { var P;if(M.el){if(M.shape){const O=M.el.closest(".beae-slider-items");O&&!O.hasAttribute("data-svg")&&(O==null||O.closest(".beae-section").insertAdjacentHTML("beforeend",`
                            <svg width="0" height="0" style="height: 0px !important; width: 0px !important; opacity: 0 !important;">
                            <defs>
        ...
        console.error('BEAE JS ERROR ID beae-fncz5lzu: ', ex)
      };
    

      try {
        let argid = 'beae-nosn6m52block-textloop-0',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-nosn6m52',
        ...
        args.els = document.querySelectorAll('.beae-nosn6m52');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-nosn6m52: ', ex)
      };
    

      try {
        let argid = 'beae-fncz5lzublock-imageloop-1',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-fncz5lzu',
      ...
      try {
        let argid = 'beae-nosn6m52block-textloop-1',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-nosn6m52',
      ...
      try {
        let argid = 'beae-fncz5lzublock-imageloop-2',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-fncz5lzu',
      ...
      try {
        let argid = 'beae-nosn6m52block-textloop-2',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-nosn6m52',
      ...
      try {
        let argid = 'beae-tuasn4fpsection-js',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-tuasn4fp',
        ...
        args.els = document.querySelectorAll('.beae-tuasn4fp');
        args.el = args.els[0];
        ((t) => { var o;if((o=t.el.querySelector(".beae-grid-system"))==null||o.addEventListener("scroll",a=>{var r,l;let n=a.target;if(!n.classList.contains("beae-grid-carousel"))return;let s=Math.round((n.scrollLeft+n.querySelector(".beae-grid-carousel__snaps").offsetLeft)/(n.offsetWidth*.8))+1;(r=t.el.querySelector(".beae-grid-carousel__pagination div.active"))==null||r.classList.remove("active"),(l=t.el.querySelector('.beae-grid-carousel__pagination div[data-index="'+s+'"]'))==null||l.classList.add("active")}),t.mode.value=="live"){const a=t.el.querySelector('.beae-section-background-video[data-device="desktop"]'),n=t.el.querySelector('.beae-section-background-video[data-device="mobile"]'),s=[];window.BEAEVIDEO&&window.BEAEVIDEO.convertBackgroundSection&&(window.innerWidth>=768?a&&window.BEAEVIDEO.convertBackgroundSection(t.optionsVideo,a)&&s.push("desktop"):n&&window.BEAEVIDEO.convertBackgroundSection(t.optionsVideoMobile,n)&&s.push("mobile")),(a||n)&&window.addEventListener("resize",()=>{if(window.BEAEVIDEO&&window.BEAEVIDEO.convertBackgroundSection){if(!s.includes("desktop")&&window.innerWidth>=768&&a){const r=window.BEAEVIDEO.convertBackgroundSection(t.optionsVideo,a);r&&(a.innerHTML=r.html,s.push("desktop"))}if(!s.includes("mobile")&&window.innerWidth<768&&n){const r=window.BEAEVIDEO.convertBackgroundSection(t.optionsVideoMobile,n);r&&(n.innerHTML=r.html,s.push("mobile"))}}})}t.el.querySelectorAll(".beae-text-highlight").forEach(a=>{new IntersectionObserver((s,r)=>{s.forEach(l=>{l.isIntersecting&&(l.target.querySelectorAll("path, line").forEach(c=>{c.style.strokeDasharray=parseFloat(c.getAttribute("data-dash-ratio")*l.target.offsetWidth*2)+"px, 999999px"}),r.unobserve(l.target))})},{root:document,rootMargin:"0px 0px -40%"}).observe(a)}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-tuasn4fp: ', ex)
      };
    

      try {
        let argid = 'beae-2324jm1asection-featured-product',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-2324jm1a',
        ...
        ((a) => { var k,$;const n=a.el.querySelector('script[data-id="Product-json-'+a.id+'"]')||a.el.querySelector("#Product-json-"+a.id);let t=!1;const o=JSON.parse(n!=null&&n.innerHTML?n==null?void 0:n.innerHTML:"{}");let r=o!=null&&o.selected_or_first_available_variant?o==null?void 0:o.selected_or_first_available_variant:(k=o.variants)==null?void 0:k[0];window.BeaeMoneyFormat||(window.BeaeMoneyFormat=($=a.el.querySelector(".beae-money-format"))==null?void 0:$.innerHTML),r&&(r=o.variants.find(w=>w.id==r.id)),x(r);function s(w){const v=a.el.querySelector(".beae-attr-sku");if(w){if(v){v.style.removeProperty("display");const M=v.querySelector(".beae-attr-value");M&&(M.innerHTML=`${w.sku?w.sku:"N/A"}`)}}else v&&(v.style.display="none")}function u(w){var v,M,L,V,T;if(w!=null&&w.unitPriceMeasurement){const N=(v=a.el)==null?void 0:v.querySelectorAll(".product__unit-price");if(N){let E="",P=window.BeaeFormatMoney(w.unitPrice);P&&typeof P=="string"&&(P=P.replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&amp;/g,"&").replace(/&quot;/g,'"').replace(/&#39;/g,"'")),((M=w.unitPriceMeasurement)==null?void 0:M.referenceValue)!=1&&((L=w.unitPriceMeasurement)==null?void 0:L.referenceValue)!=0&&(E+=w.unitPriceMeasurement.referenceValue),((V=w.unitPriceMeasurement)==null?void 0:V.referenceUnit)!==null&&((T=w.unitPriceMeasurement)==null?void 0:T.referenceUnit)!==""&&(E+=w.unitPriceMeasurement.referenceUnit),N.forEach(H=>{P!=null&&P!=""&&E!=null&&E!=""?H.innerHTML=`${P}/${E}`:H.innerHTML="Price per unit not available"})}}}function c(w){if(!window.BeaeMoneyFormat)return;const v=a.el.querySelectorAll(".beae-product-single__price:not(.beae-recommendation-item .beae-product-single__price)");v&&v.forEach(L=>{if(L){let V=window.BeaeFormatMoney(w.price);V&&typeof V=="string"&&(V=V.replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&amp;/g,"&").replace(/&quot;/g,'"').replace(/&#39;/g,"'")),L.innerHTML=V}});const M=a.el.querySelectorAll(".beae-product-single__price--regular:not(.beae-recommendation-item .beae-product-single__price--regular)");M&&M.forEach(L=>{var V,T;if(L){const N=L.parentNode;if(w.compare_at_price){L.style.display="block";let E=window.BeaeFormatMoney(w.compare_at_price);E&&typeof E=="string"&&(E=E.replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&amp;/g,"&").replace(/&quot;/g,'"').replace(/&#39;/g,"'")),L.innerHTML=E,(V=N==null?void 0:N.querySelector(".beae-product-single__price"))==null||V.setAttribute("data-sale",!0)}else L.style.display="none",(T=N==null?void 0:N.querySelector(".beae-product-single__price"))==null||T.removeAttribute("data-sale")}})}function d(w){var V,T,N,E;const v=a.el.querySelectorAll(".beae-product-single__price--badged"),M=parseFloat((T=(V=w.price)==null?void 0:V.toString())==null?void 0:T.replace(",","")),L=parseFloat((E=(N=w.compare_at_price)==null?void 0:N.toString())==null?void 0:E.replace(",",""));v&&v.forEach(P=>{if(!P)return;const H=P.getAttribute("type"),I=P.getAttribute("data-sale")||"",A=P.getAttribute("data-sold-out");let O="";if(H=="percent")O=Math.floor((L-M)*100/L);else if(H=="dollar"){const F=window.BeaeFormatDecimal(w.compare_at_price)-window.BeaeFormatDecimal(w.price);O=window.BeaeFormatMoney(window.BeaeReverseFormatDecimal(F))}else if(H=="none"){P.classList.remove("beae-product-single__price--sale","beae-sale-sold-out"),P.classList.add("beae-sale-hidden"),P.innerHTML="";return}const z=w.inventory_quantity,D=w.inventory_policy;if(z>0||z<1&&D=="continue"||!w.inventory_management)if(L&&L>M){P.classList.remove("beae-sale-sold-out","beae-sale-hidden"),P.classList.add("beae-product-single__price--sale");let F=I.replace(new RegExp("{\\s*?sale\\s*?}","g"),O);F&&(F=F.replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&amp;/g,"&").replace(/&quot;/g,'"').replace(/&#39;/g,"'")),P.innerHTML=F}else P.classList.remove("beae-product-single__price--sale","beae-sale-sold-out"),P.classList.add("beae-sale-hidden"),P.innerHTML="";else P.classList.remove("beae-sale-hidden","beae-product-single__price--sale"),P.classList.add("beae-sale-sold-out"),P.innerHTML=A})}function l(w){var V,T,N,E;const v=parseFloat((T=(V=w.price)==null?void 0:V.toString())==null?void 0:T.replace(",","")),M=parseFloat((E=(N=w.compare_at_price)==null?void 0:N.toString())==null?void 0:E.replace(",",""));let L=a.el.querySelectorAll(".beae-badged-wrapper span");L&&L.forEach(P=>{if(!P)return;const H=P.getAttribute("type"),I=P.getAttribute("data-sale")||"",A=P.getAttribute("data-sold-out");let O="";if(H=="percent")O=Math.floor((M-v)*100/M);else if(H=="dollar"){const F=window.BeaeFormatDecimal(w.compare_at_price)-window.BeaeFormatDecimal(w.price);O=window.BeaeFormatMoney(window.BeaeReverseFormatDecimal(F))}else if(H=="none"){P.classList.remove("beae-product-single__price--sale","beae-sale-sold-out"),P.classList.add("beae-sale-hidden"),P.innerHTML="";return}const z=w.inventory_quantity,D=w.inventory_policy;if(z>0||z<1&&D=="continue"||!w.inventory_management){const F=parseFloat(w.price),j=parseFloat(w.compare_at_price);if(j&&j>F){P.classList.remove("beae-sale-sold-out","beae-sale-hidden"),P.classList.add("beae-product-single__price--sale");let W=I.replace(new RegExp("{\\s*?sale\\s*?}","g"),O);W&&(W=W.replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&amp;/g,"&").replace(/&quot;/g,'"').replace(/&#39;/g,"'")),P.innerHTML=W}else P.classList.remove("beae-product-single__price--sale","beae-sale-sold-out"),P.classList.add("beae-sale-hidden"),P.innerHTML=""}else P.classList.remove("beae-sale-hidden","beae-product-single__price--sale"),P.classList.add("beae-sale-sold-out"),P.innerHTML=A})}function y(w){const v=a.el.querySelectorAll(".beae-x-product-gallery .beae-slider");v&&o&&w.featured_media&&v.forEach(M=>{const L=M.getAttribute("data-desktop-layout");if(window.innerWidth>=768&&L=="grid"){const V=M.querySelector('.beae-slide-item[data-media-id="'+w.featured_media.id+'"]');Array.from(M.querySelectorAll(".beae-slide-item.beae-grid-active")).filter(function(N){return N.nodeType===1&&N!==V}).forEach(N=>{N.classList.remove("beae-grid-active")}),_=="true"&&V.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),V&&!V.classList.contains("beae-grid-active")&&V.classList.add("beae-grid-active")}else _=="true"&&M.dispatchEvent(new CustomEvent("activeSlide",{detail:{id:w.featured_media.id},bubbles:!0,cancelable:!0,composed:!1}))})}function x(w){if(a.mode.value==="builder"&&w){const q=a.el.querySelector(".beae-x-featuted_product");q==null||q.setAttribute("data-variant-id",w.id)}const v=a.el.querySelector(".beae-x-inventory");if(!v||!w)return;const M=v.children[0],L=v.getAttribute("data-in-stock-text"),V=v.getAttribute("data-out-stock-text");v.getAttribute("data-inventory-text");const T=v.getAttribute("data-pre-order-text"),N=v.getAttribute("data-very-low-stock-text"),E=v.getAttribute("data-low-stock-text"),P=v.getAttribute("data-incoming-date-text"),H=v.getAttribute("data-low-number")??20,I=v.getAttribute("data-very-low-number")??5,A=v.getAttribute("data-show-next-incoming-date"),O=v.getAttribute("data-max-number")??60,z=v.querySelector(".beae-inventory-label"),D=v.querySelector(".beae-inventory-process-body");let F=w.inventory_quantity;a.el.querySelector(".beae-x-variant")||a.el.querySelector(".beae-x-swatch-color")||a.el.querySelector(".beae-x-add-to-cart-with-option")||(F=o.variants.reduce((q,R)=>q+(R.inventory_quantity||0),0));function W(q){return q?q.replace("{quantity}",F).replace("{next_incoming_date}",w.next_incoming_date):""}!M||!z||(w.available?w.inventory_policy==="continue"&&F<1?(z.innerHTML=W(T),M.classList="",M.classList.add("beae-inventory-pre-order")):F<=I?(z.innerHTML=W(N),M.classList="",M.classList.add("beae-inventory-very-low")):F<=H?(z.innerHTML=W(E),M.classList="",M.classList.add("beae-inventory-low")):(z.innerHTML=W(L),M.classList="",M.classList.add("beae-inventory-in-stock")):w.next_incoming_date&&A?(z.innerHTML=W(P),M.classList="",M.classList.add("beae-incoming-transfer")):(z.innerHTML=W(V),M.classList="",M.classList.add("beae-inventory-out-stock")),D&&(F<=O?D.style.width=F/O*100+"%":D.style.width="100%"))}function g(w){const v=a.el.querySelector(".beae-add-to-cart--submit");if(v){const L=v.querySelector(".beae-add-to-cart-text-content");w.available?v&&(v.removeAttribute("disabled"),L&&(L.innerHTML=v.getAttribute("data-add-to-cart-text"))):v&&(a.mode.value=="live"&&v.setAttribute("disabled","disabled"),L&&(L.innerHTML=v.getAttribute("data-sold-out-text")))}const M=a.el.querySelector(".shopify-payment-button__button");M&&(w.inventory_quantity>0?M.removeAttribute("disabled"):a.mode.value=="live"&&M.setAttribute("disabled","disabled"))}function h(w){const v=a.el.querySelector(".beae-quantity-input"),M=a.el.querySelectorAll(".beae-quantity-btn");if(M&&M.forEach(L=>{w&&w.available?L.removeAttribute("disabled"):a.mode.value=="live"&&L.setAttribute("disabled","disabled")}),v){if(w)w.available?v.removeAttribute("disabled"):a.mode.value=="live"&&v.setAttribute("disabled","disabled");else{v.value=1,a.mode.value=="live"&&v.setAttribute("disabled","disabled");return}const L=w.inventory_quantity,V=w.inventory_policy;let T=9999;w.inventory_management&&V==="deny"&&(T=L),L<1&&V=="continue"&&(T=999999);let N=parseInt(v.value);N>T&&(N=T),N=isNaN(N)||!N?1:N,v.value=N,v.setAttribute("max",T)}}function p(w){if(w){let v=a.el.querySelector(".beae-pa-container");if(v&&a.mode.value=="live"){const M=v.getAttribute("data-section-id-template");v.innerHTML="";const V=window.location.pathname.split("/").filter(N=>N);let T="";V.length>0&&(V[0].length===2||/^[a-z]{2}(-[A-Z]{2})?$/.test(V[0]))&&(T=V[0]+"/"),window.fetch(window.location.origin+"/"+T+"products/"+o.handle+"?variant="+w.id+"&section_id="+M,{method:"GET",headers:{"Content-Type":"text/html"}}).then(N=>N.text()).then(N=>{let E=N.match(/<Beae-custom-liquid-pickup>(|[\s\S]+?)<\/Beae-custom-liquid-pickup>/g);E&&E[0]&&(v.innerHTML=E[0]);let P=v.querySelector(".beae-pa--btn"),H=v.querySelector(".beae-pa--detail");if(P){const I=v.closest("section.beae-section");I&&I.getAttribute("data-sectionid"),P.addEventListener("click",()=>{window.BeaePopupLibrary.createPopup(H,{layout:v.getAttribute("data-layout"),layoutMobile:"bottom",width:v.getAttribute("data-width"),id:a.id})})}}).catch(N=>{console.warn(N.message)})}}}const f=a.el.querySelector(".beae-variant-size-guide");if(f){const w=f.querySelector(".beae-variant-size-guide-btn"),v=f.querySelector(".beae-variant-size-guide-content"),M=a.el.querySelector(".beae-content-size-chart-preview");let L=window.isPreviewTemplate&&M||v;if(w&&L){const V=a.el.getAttribute("data-sectionid");w.addEventListener("click",()=>{window!=null&&window.BeaePopupLibrary&&window.BeaePopupLibrary.createPopup(L,{layout:"center",layoutMobile:"bottom",width:"auto",sectionId:V})})}}const b=a.el.querySelectorAll(".beae-custom-select_wrp");b&&b.length&&a.mode.value=="live"&&b.forEach(w=>{const v=w.querySelector("button.beae-custom-select__btn"),M=w.closest("div.beae-block.beae-core");v.addEventListener("click",function(L){w.classList.toggle("active"),M.style.position="relative",M.style.zIndex="1"}),document.addEventListener("click",function(L){w.contains(L.target)||(w.classList.remove("active"),M.style={})})});function C(){const w=a.el.querySelector(".beae-custom-select_wrp.active");w&&w.classList.remove("active")}const m=a.el.querySelector(".beae-x-variant"),_=m==null?void 0:m.getAttribute("data-scroll");let S=!1;if(m){let w=function(O,z){if(!O)return[];let D=O.options.filter((F,j)=>j!=z);return o.variants.filter(F=>D.every(j=>F.options.includes(j)))??[]},v=function(O,z,D){if(!O)return null;let F=O.options.filter((j,W)=>W!=z);return o.variants.find(j=>j.options.every(W=>[D,...F].includes(W)))},M=function(O){if(!O)return;const z=a.el.querySelector("form.beae-product-form-next");if(z){z.getAttribute("data-variant-id",O.id);const D=z.querySelector('input[type="hidden"][name="id"]');D&&D.setAttribute("value",O.id)}m.querySelectorAll(".beae-variant-label").forEach(D=>{const F=parseInt(D.getAttribute("data-option-position"))-1;D.innerHTML=O.options[F]}),P||m.querySelectorAll(".beae-product-images-list").forEach(D=>{const F=parseInt(D.getAttribute("data-option-position"))-1;let j=[];w(O,F).forEach(W=>{j.push(`
                    ...
                    `)}),D.querySelectorAll(".beae-product-variant-item-image").forEach((W,q)=>{W.innerHTML=j[q]})}),m.querySelectorAll(".beae-product-variant-item").forEach(D=>{const F=parseInt(D.getAttribute("data-option-position"))-1;let j="";const W=D.getAttribute("data-value");if(W)try{j=decodeURIComponent(W)}catch{j=W}const q=v(O,F,j);q&&(D.setAttribute("data-variant-id",q.id),q.inventory_management&&q.inventory_quantity<1&&q.inventory_policy!="continue"?D.classList.add("variant-item-disable"):D.classList.remove("variant-item-disable"))})},L=function(O){O.options.forEach((z,D)=>{let F=D+1;const j=m.querySelectorAll('.beae-variant-option-list[data-option-position="'+F+'"] > li');let W=null;const q=m.querySelector("select#"+A+"-option-"+D);if(q){for(let U=0;U<j.length;U++)j[U].classList.remove("beae-product-variant-item--selected"),decodeURIComponent(j[U].getAttribute("data-value"))==z&&(W=j[U]);W&&W.classList.add("beae-product-variant-item--selected"),q.value=z}const R=W&&W.closest(".beae-custom-select_wrp");if(R){const U=W&&W.getAttribute("data-color"),Z=R.querySelector(".beae-selected-color");Z&&(Z.style="--beae-color-variant: "+U);const G=R.querySelector(".beae-text-selected");G&&(G.innerHTML=z)}})},V=function(O,z){N(O),O&&(t=!0,r=O,x(O),h(O),g(O),d(O),l(O),M(O),c(O),s(O),u(O),E?(E=!1,new URLSearchParams(window.location.search).get("variant")&&!window.noUpdateImageFirstLoad&&setTimeout(()=>{y(O)})):y(O),p(O),a.el.dispatchEvent(new CustomEvent("changeVariant",{detail:{variant:O},bubbles:!0,cancelable:!0,composed:!1})))},T=function(){const O=a.el.querySelector('.beae-product-option-cont[data-swatch-type="variant_image"]');if(!O)return;const z=O.getAttribute("data-option-position"),D="//cdn.shopify.com/shopifycloud/shopify/assets/no-image-160-1cfae84eca4ba66892099dcd26e604f5801fdadb3693bc9977f476aa160931ac_120x120_crop_center.gif",F=a.el.querySelectorAll('.beae-product-option-cont:not([data-swatch-type="variant_image"])'),j={};F&&F.length&&F.forEach(R=>{const U=R.querySelector(".beae-product-variant-item--selected");if(!U)return;const Z=U.getAttribute("data-option-position"),G=decodeURIComponent(U.getAttribute("data-value"));j["option"+Z]=G});const W=o.variants.filter(R=>Object.keys(j).every(U=>j[U]==R[U])),q=O.querySelectorAll(".beae-product-variant-item");q&&q.length&&q.forEach(R=>{const U=decodeURIComponent(R.getAttribute("data-value")),Z=W.find(G=>G["option"+z]==U);R.querySelector("img")||(R.innerHTML=`
                      ...
                      `)})},N=function(O){let z=o.variants,D=O&&O.option1,F=O&&O.option2;if(!O){const q=a.el.querySelector('.beae-variant-option-list[data-option-position="1"] .beae-product-variant-item--selected');q&&(D=decodeURIComponent(q.getAttribute("data-value")));const R=a.el.querySelector('.beae-variant-option-list[data-option-position="2"] .beae-product-variant-item--selected');R&&(F=decodeURIComponent(R.getAttribute("data-value")))}let j=[],W=[];if(D&&(z=o.variants.filter(q=>q.option1==D),z.forEach(q=>{q.option2&&!(j!=null&&j.includes(q.option2))&&j.push(q.option2)}),z.forEach(q=>{q.option2==F&&q.option3&&!(W!=null&&W.includes(q.option3))&&W.push(q.option3)})),[2,3].forEach(q=>{const R=a.el.querySelectorAll('.beae-variant-option-list[data-option-position="'+q+'"] .beae-product-variant-item');if(R){let U=q==2?j:W;R.forEach(Z=>{const G=decodeURIComponent(Z.getAttribute("data-value"));U.includes(G)?Z.setAttribute("data-unavailable",!1):Z.setAttribute("data-unavailable",!0)})}}),!O){if(j&&j.length){const q=a.el.querySelector('.beae-variant-option-list[data-option-position="2"] .beae-product-variant-item--selected[data-unavailable="false"]'),R=a.el.querySelector('.beae-variant-option-list[data-option-position="2"] .beae-product-variant-item[data-unavailable="false"]');!q&&R&&R.click()}if(W&&W.length){a.el.querySelector('.beae-variant-option-list[data-option-position="3"] .beae-product-variant-item--selected[data-unavailable="false"]');const q=a.el.querySelector('.beae-variant-option-list[data-option-position="3"] .beae-product-variant-item[data-unavailable="false"]');q&&q.click()}}T()},E=!0,P=!1,H=m.querySelector('select[name="id"]'),I=!0;a.el.addEventListener("activeVariant",function(O){if(I){I=!1;return}if(t){t=!1;return}if(!o.variants||!O.detail.id||r&&r.featured_media&&O.detail.id==r.featured_media.id)return;const z=o.variants.find(D=>!D||!D.featured_media||!D.featured_media.id||!O.detail.id?!1:D.featured_media.id==O.detail.id);!z||r.id==z.id||(L(z),N(z),r=z,x(z),h(z),g(z),M(z),c(z),d(z),l(z),p(z),s(z),u(z))});const A=H&&H.getAttribute("id");if(H&&window.Shopify&&window.Shopify.OptionSelectors){let O=function(z){var R;E=!1;const D=parseInt(z.getAttribute("data-option-position"))-1,F=m.querySelector("select#"+A+"-option-"+D);let j=z.getAttribute("data-value")??z.value,W="";try{W=decodeURIComponent(j)}catch{W=j}if(F){const U=((R=z.parentElement)==null?void 0:R.children)??[];for(let Z=0;Z<U.length;Z++)U[Z].classList.remove("beae-product-variant-item--selected");z.classList.add("beae-product-variant-item--selected"),F.value=W,F.onchange()}const q=z.closest(".beae-custom-select_wrp");if(q){const U=z.getAttribute("data-color"),Z=q.querySelector(".beae-selected-color");Z&&(Z.style="--beae-color-variant: "+U);const G=q.querySelector(".beae-text-selected");G&&(G.innerHTML=W)}};new window.Shopify.OptionSelectors(A,{product:o,onVariantSelected:V,enableHistoryState:a.mode.value=="live"}),m.querySelectorAll(".beae-product-variant-item").forEach(z=>{if(z.querySelector("a.beae-variant--link"))return;const D=z.getAttribute("data-link");z.addEventListener("click",F=>{if(F.target.closest(".beae-product-variant-item-image")){if(D&&D!=="#"){window.location.href=D;return}P=!0,O(z);return}(!D||D==="#")&&(P=!1,O(z),C())})})}}else S=!0;o.has_only_default_variant&&(S=!0),S&&B();function B(){r&&((r==null?void 0:r.title)=="Default Title"&&(r=o.variants[0]),x(r),h(r),g(r),d(r),l(r))} })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-2324jm1a: ', ex)
      };
    

      try {
        let argid = 'beae-1u5281jeblock-gallery',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-1u5281je',
        ...
        args.els = document.querySelectorAll('.beae-1u5281je');
        args.el = args.els[0];
      ...
      `,document.body.appendChild(o),document.body.style.overflow="hidden";let u=o.querySelector("button.beae-gallery-zoom-close"),c=o.querySelector(".beae-gallery-zoom"),d=o.querySelector(".beae-gallery-zoom-content"),l=o.querySelector(".beae-gallery-zoom-pagination .pagination_item.per"),y=o.querySelector(".pagination_item.prev"),x=o.querySelector(".pagination_item.next"),g=o.querySelectorAll(".beae-gallery-zoom-item"),h=o.querySelector(".beae-gallery-zoom-controls"),p=()=>{let b=o.querySelector(".beae-gallery-zoom-item.active"),C=0;Array.from(r).forEach(m=>{var _;((_=m.getAttribute("type"))==null?void 0:_.toLowerCase())=="image"&&C++}),C<2?h.style.display="none":h.style.display="flex",l.textContent=`${Array.from(o.querySelectorAll(".beae-gallery-zoom-item")).indexOf(b)+1} / ${C}`};p(),u.addEventListener("click",b=>{c.classList.remove("opened")}),o.querySelectorAll(".beae-gallery-zoom-item img").forEach(b=>{b.addEventListener("mousemove",C=>{b.parentNode.classList.contains("beae-gallery-zoom-more")?b.parentNode.classList.contains("beae-gallery-zoom-more")&&(b.style.objectFit==="cover"?b.style.objectPosition=100*(C.clientX/b.offsetWidth)+"% "+100*((C.clientY-b.offsetTop)/b.offsetHeight)+"%":b.style.objectPosition&&(b.style.objectPosition="")):(b.parentNode.classList.add("beae-gallery-zoom-more"),b.style.cursor="zoom-in",b.addEventListener("click",m=>{b.style.objectFit==="cover"?(b.style.objectFit="contain",m.target.style.transition="",b.style.cursor="zoom-in",b.style.objectPosition=""):(b.style.objectFit="cover",b.style.cursor="zoom-out",b.style.objectPosition=100*(m.clientX/b.offsetWidth)+"% "+100*((m.clientY-b.offsetTop)/b.offsetHeight)+"%")}))})}),c.addEventListener("transitionend",b=>{b.propertyName==="opacity"&&(c.classList.contains("opened")?(u.style.opacity=1,o.querySelectorAll(".beae-gallery-zoom-item img").forEach(C=>{C.removeAttribute("srcset"),C.removeAttribute("sizes")}),o.querySelector(".beae-gallery-zoom-item.active").style.order="",d.scrollTo({left:o.querySelector(".beae-gallery-zoom-item.active").offsetLeft})):(o.remove(),document.body.style.overflow=""))});let f=0;d.addEventListener("scroll",b=>{clearTimeout(f),f=setTimeout(()=>{g.forEach(C=>{Math.abs(b.target.scrollLeft-C.offsetLeft)<2?(C.classList.add("active"),p()):C.classList.remove("active")})},250)}),y.addEventListener("click",()=>{let b=o.querySelector(".beae-gallery-zoom-item.active");if(b.previousElementSibling)b.previousElementSibling.classList.add("active");else if(g[g.length-1]&&g.length>1)g[g.length-1].classList.add("active");else return;b.classList.remove("active"),d.scrollTo({behavior:"smooth",left:o.querySelector(".beae-gallery-zoom-item.active").offsetLeft}),p()}),x.addEventListener("click",()=>{let b=o.querySelector(".beae-gallery-zoom-item.active");if(b&&b.nextElementSibling)b.nextElementSibling.classList.add("active");else if(g[0]&&g.length>1)g[0].classList.add("active");else return;b.classList.remove("active"),d.scrollTo({behavior:"smooth",left:o.querySelector(".beae-gallery-zoom-item.active").offsetLeft}),p()}),setTimeout(()=>{c.classList.add("opened")},10)}))},1e3) })(args);
        ...
        console.error('BEAE JS ERROR ID beae-1u5281je: ', ex)
      };
    

      try {
        let argid = 'beae-1u5281jesection-slide-show',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-1u5281je',
      ...
      try {
        let argid = 'beae-owe8ccwkblock-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-owe8ccwk',
        ...
        args.els = document.querySelectorAll('.beae-owe8ccwk');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-owe8ccwk: ', ex)
      };
    

      try {
        let argid = 'beae-6xf4i2tpblock-add-to-cart',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-6xf4i2tp',
        ...
        args.els = document.querySelectorAll('.beae-6xf4i2tp');
        args.el = args.els[0];
        ...
        console.error('BEAE JS ERROR ID beae-6xf4i2tp: ', ex)
      };
    

      try {
        let argid = 'beae-ovvbh92hblock-tabs',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-ovvbh92h',
        ...
        args.els = document.querySelectorAll('.beae-ovvbh92h');
        args.el = args.els[0];
        ...
        console.error('BEAE JS ERROR ID beae-ovvbh92h: ', ex)
      };
    

      try {
        let argid = 'beae-rtvwgia0block-description',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-rtvwgia0',
      ...
      try {
        ...
        args.els = document.querySelectorAll('.beae-rr92nx8s');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-rr92nx8s: ', ex)
      };
    

      try {
        let argid = 'beae-tc205o0pblock-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-tc205o0p',
        ...
        args.els = document.querySelectorAll('.beae-tc205o0p');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-tc205o0p: ', ex)
      };
    

      try {
        let argid = 'beae-lgbvg758section-js',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-lgbvg758',
        ...
        args.els = document.querySelectorAll('.beae-lgbvg758');
        args.el = args.els[0];
        ((t) => { var o;if((o=t.el.querySelector(".beae-grid-system"))==null||o.addEventListener("scroll",a=>{var r,l;let n=a.target;if(!n.classList.contains("beae-grid-carousel"))return;let s=Math.round((n.scrollLeft+n.querySelector(".beae-grid-carousel__snaps").offsetLeft)/(n.offsetWidth*.8))+1;(r=t.el.querySelector(".beae-grid-carousel__pagination div.active"))==null||r.classList.remove("active"),(l=t.el.querySelector('.beae-grid-carousel__pagination div[data-index="'+s+'"]'))==null||l.classList.add("active")}),t.mode.value=="live"){const a=t.el.querySelector('.beae-section-background-video[data-device="desktop"]'),n=t.el.querySelector('.beae-section-background-video[data-device="mobile"]'),s=[];window.BEAEVIDEO&&window.BEAEVIDEO.convertBackgroundSection&&(window.innerWidth>=768?a&&window.BEAEVIDEO.convertBackgroundSection(t.optionsVideo,a)&&s.push("desktop"):n&&window.BEAEVIDEO.convertBackgroundSection(t.optionsVideoMobile,n)&&s.push("mobile")),(a||n)&&window.addEventListener("resize",()=>{if(window.BEAEVIDEO&&window.BEAEVIDEO.convertBackgroundSection){if(!s.includes("desktop")&&window.innerWidth>=768&&a){const r=window.BEAEVIDEO.convertBackgroundSection(t.optionsVideo,a);r&&(a.innerHTML=r.html,s.push("desktop"))}if(!s.includes("mobile")&&window.innerWidth<768&&n){const r=window.BEAEVIDEO.convertBackgroundSection(t.optionsVideoMobile,n);r&&(n.innerHTML=r.html,s.push("mobile"))}}})}t.el.querySelectorAll(".beae-text-highlight").forEach(a=>{new IntersectionObserver((s,r)=>{s.forEach(l=>{l.isIntersecting&&(l.target.querySelectorAll("path, line").forEach(c=>{c.style.strokeDasharray=parseFloat(c.getAttribute("data-dash-ratio")*l.target.offsetWidth*2)+"px, 999999px"}),r.unobserve(l.target))})},{root:document,rootMargin:"0px 0px -40%"}).observe(a)}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-lgbvg758: ', ex)
      };
    

      try {
        let argid = 'beae-t03qaxkyblock-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-t03qaxky',
        ...
        args.els = document.querySelectorAll('.beae-t03qaxky');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-t03qaxky: ', ex)
      };
    

      try {
        let argid = 'beae-weupyl7zblock-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-weupyl7z',
        ...
        args.els = document.querySelectorAll('.beae-weupyl7z');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-weupyl7z: ', ex)
      };
    

      try {
        let argid = 'beae-v0uba3hgsection-slide-show',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-v0uba3hg',
        ...
        args.els = document.querySelectorAll('.beae-v0uba3hg');
        args.el = args.els[0];
        ((h) => { window.BeaeSlider&&!h.noRunJs&&window.BeaeSlider(h) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-v0uba3hg: ', ex)
      };
    

      try {
        let argid = 'beae-08bwlu50block-imageloop-0',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-08bwlu50',
        ...
        args.els = document.querySelectorAll('.beae-08bwlu50');
        args.el = args.els[0];
        ((M) => { var P;if(M.el){if(M.shape){const O=M.el.closest(".beae-slider-items");O&&!O.hasAttribute("data-svg")&&(O==null||O.closest(".beae-section").insertAdjacentHTML("beforeend",`
                            <svg width="0" height="0" style="height: 0px !important; width: 0px !important; opacity: 0 !important;">
                            <defs>
        ...
        console.error('BEAE JS ERROR ID beae-08bwlu50: ', ex)
      };
    

      try {
        let argid = 'beae-08bwlu50block-imageloop-1',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-08bwlu50',
      ...
      try {
        let argid = 'beae-mitu2om1section-js',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-mitu2om1',
        ...
        args.els = document.querySelectorAll('.beae-mitu2om1');
        args.el = args.els[0];
        ((t) => { var o;if((o=t.el.querySelector(".beae-grid-system"))==null||o.addEventListener("scroll",a=>{var r,l;let n=a.target;if(!n.classList.contains("beae-grid-carousel"))return;let s=Math.round((n.scrollLeft+n.querySelector(".beae-grid-carousel__snaps").offsetLeft)/(n.offsetWidth*.8))+1;(r=t.el.querySelector(".beae-grid-carousel__pagination div.active"))==null||r.classList.remove("active"),(l=t.el.querySelector('.beae-grid-carousel__pagination div[data-index="'+s+'"]'))==null||l.classList.add("active")}),t.mode.value=="live"){const a=t.el.querySelector('.beae-section-background-video[data-device="desktop"]'),n=t.el.querySelector('.beae-section-background-video[data-device="mobile"]'),s=[];window.BEAEVIDEO&&window.BEAEVIDEO.convertBackgroundSection&&(window.innerWidth>=768?a&&window.BEAEVIDEO.convertBackgroundSection(t.optionsVideo,a)&&s.push("desktop"):n&&window.BEAEVIDEO.convertBackgroundSection(t.optionsVideoMobile,n)&&s.push("mobile")),(a||n)&&window.addEventListener("resize",()=>{if(window.BEAEVIDEO&&window.BEAEVIDEO.convertBackgroundSection){if(!s.includes("desktop")&&window.innerWidth>=768&&a){const r=window.BEAEVIDEO.convertBackgroundSection(t.optionsVideo,a);r&&(a.innerHTML=r.html,s.push("desktop"))}if(!s.includes("mobile")&&window.innerWidth<768&&n){const r=window.BEAEVIDEO.convertBackgroundSection(t.optionsVideoMobile,n);r&&(n.innerHTML=r.html,s.push("mobile"))}}})}t.el.querySelectorAll(".beae-text-highlight").forEach(a=>{new IntersectionObserver((s,r)=>{s.forEach(l=>{l.isIntersecting&&(l.target.querySelectorAll("path, line").forEach(c=>{c.style.strokeDasharray=parseFloat(c.getAttribute("data-dash-ratio")*l.target.offsetWidth*2)+"px, 999999px"}),r.unobserve(l.target))})},{root:document,rootMargin:"0px 0px -40%"}).observe(a)}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-mitu2om1: ', ex)
      };
    

      try {
        let argid = 'beae-l4aq4rk4block-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-l4aq4rk4',
        ...
        args.els = document.querySelectorAll('.beae-l4aq4rk4');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-l4aq4rk4: ', ex)
      };
    

      try {
        let argid = 'beae-2mz5gi6rblock-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-2mz5gi6r',
        ...
        args.els = document.querySelectorAll('.beae-2mz5gi6r');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-2mz5gi6r: ', ex)
      };
    

      try {
        let argid = 'beae-3i4vyxxbblock-tabs',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-3i4vyxxb',
        ...
        args.els = document.querySelectorAll('.beae-3i4vyxxb');
        args.el = args.els[0];
        ((data) => { const prefixClass=`div[data-id=${data.id}] > .beae-tab-wrp`;let tabs=data.el.querySelectorAll(`${prefixClass} > .beae-tab-items > .beae-tab-item`),contents=data.el.querySelectorAll(`${prefixClass} > .beae-tab-contents > .beae-tab-content`),rightside=data.el.querySelectorAll(`${prefixClass} .beae-rightside`),accordions=data.el.querySelectorAll(`${prefixClass} > .beae-tab-contents > .beae-tab-content > .beae-accordion-title--mobile`),activeTab=window.outerWidth&&window.outerWidth<=768?data.activeTabMobile:data.activeTab,toggleImg=data.toggleImg,layout=data.layout,accordionMode=data.accordionMode;function resetActive(){tabs.forEach(f=>f.classList.remove("active")),contents.forEach(f=>f.classList.remove("active")),accordions.forEach(f=>f.classList.remove("active")),toggleImg&&rightside.forEach(f=>f.classList.remove("active")),contents.forEach(f=>{const b=f.querySelector(".beae-accordion-body").style;layout=="accordions"?b.maxHeight="0px":(b.transform="scaleY(0)",b.opacity="0")})}function setActive(f){tabs[f].classList.add("active"),contents[f].classList.add("active"),accordions[f].classList.add("active"),toggleImg&&rightside[f].classList.add("active");const b=contents[f].querySelector(".beae-accordion-body");if(b){const C=b.style;layout=="accordions"?C.maxHeight=data.mode.value=="builder"?"":b.scrollHeight+"px":(C.transform="scaleY(1)",C.transformOrigin="top center",C.opacity="1")}}function removeActive(f){tabs[f].classList.remove("active"),contents[f].classList.remove("active"),accordions[f].classList.remove("active"),toggleImg&&rightside[f].classList.remove("active");const b=contents[f].querySelector(".beae-accordion-body").style;layout=="accordions"?b.maxHeight="0px":(b.transform="scaleY(0)",b.opacity="0")}resetActive(),activeTab!=="none"&&accordionMode!="popup"&&setActive(activeTab),tabs.forEach((f,b)=>{f.addEventListener("click",()=>{resetActive(),setActive(b)})});const section=data.el.closest("section.beae-section");let sectionId="";section&&(sectionId=section.getAttribute("data-sectionid"));let extOptions={};if(data.extendOptions)try{eval("extOptions = "+data.extendOptions)}catch(f){extOptions={},console.error(f)}if(accordions.forEach((f,b)=>{f.addEventListener("click",()=>{if(accordionMode=="popup"&&data.mode.value!="builder"){const C=f.closest(".beae-tab-content");if(C){let m=document.createElement("div");m.innerHTML=`
                            <h3 class="beae-popup__content-title">${f.querySelector("span").innerHTML}</h3>
                            <div class="beae-popup__content-body ${data.id}">${C.querySelector(".beae-accordion-body").innerHTML}</div>
        ...
        console.error('BEAE JS ERROR ID beae-3i4vyxxb: ', ex)
      };
    

      try {
        let argid = 'beae-j96e3ifjblock-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-j96e3ifj',
        ...
        args.els = document.querySelectorAll('.beae-j96e3ifj');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-j96e3ifj: ', ex)
      };
    

      try {
        let argid = 'beae-56t576ygblock-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-56t576yg',
        ...
        args.els = document.querySelectorAll('.beae-56t576yg');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-56t576yg: ', ex)
      };
    

      try {
        let argid = 'beae-s5yeig4dblock-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-s5yeig4d',
        ...
        args.els = document.querySelectorAll('.beae-s5yeig4d');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-s5yeig4d: ', ex)
      };
    

      try {
        let argid = 'beae-3hmeezwxblock-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-3hmeezwx',
        ...
        args.els = document.querySelectorAll('.beae-3hmeezwx');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-3hmeezwx: ', ex)
      };
    

      try {
        let argid = 'beae-44agirkiblock-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-44agirki',
        ...
        args.els = document.querySelectorAll('.beae-44agirki');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-44agirki: ', ex)
      };
    

      try {
        let argid = 'beae-b4d8xqdablock-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-b4d8xqda',
        ...
        args.els = document.querySelectorAll('.beae-b4d8xqda');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-b4d8xqda: ', ex)
      };
    

      try {
        let argid = 'beae-vyaayq26block-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-vyaayq26',
        ...
        args.els = document.querySelectorAll('.beae-vyaayq26');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-vyaayq26: ', ex)
      };
    

      try {
        let argid = 'beae-1a6km6y4block-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-1a6km6y4',
        ...
        args.els = document.querySelectorAll('.beae-1a6km6y4');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-1a6km6y4: ', ex)
      };
    

      try {
        let argid = 'beae-snucp8foblock-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-snucp8fo',
        ...
        args.els = document.querySelectorAll('.beae-snucp8fo');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-snucp8fo: ', ex)
      };
    

      try {
        let argid = 'beae-o78xjll0block-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-o78xjll0',
        ...
        args.els = document.querySelectorAll('.beae-o78xjll0');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-o78xjll0: ', ex)
      };
    

      try {
        let argid = 'beae-7nc01m6zblock-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-7nc01m6z',
        ...
        args.els = document.querySelectorAll('.beae-7nc01m6z');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-7nc01m6z: ', ex)
      };
    

      try {
        let argid = 'beae-uwrqmb19block-text',
          args = window.BEAEARGS[argid];
        if (!args) {
          args = {
            id: 'beae-uwrqmb19',
        ...
        args.els = document.querySelectorAll('.beae-uwrqmb19');
        args.el = args.els[0];
        ((P) => { var I;let H=(I=P.el)==null?void 0:I.querySelectorAll(".beae-x-text a");H==null||H.forEach(A=>{let O=A==null?void 0:A.getAttribute("href");A&&P.mode.value!=="builder"&&(O!=null&&O.includes("#"))&&A.addEventListener("click",z=>{let D=document.querySelector(O+","+(O==null?void 0:O.replace("#",".")));if(D)return D.scrollIntoView({behavior:"smooth",block:"center",inline:"center"}),z.preventDefault(),!1})}) })(args);
      }  catch (ex) {
        console.error('BEAE JS ERROR ID beae-uwrqmb19: ', ex)
      };
    }; if (window.BEAEBASE) {js_NPNJCNA9()} else {window.BEAEPAGEJS.push(js_NPNJCNA9)} })(); 